...
Cabe señalar que la sensibilidad del RPM a la intensidad del campo no es monótona. La mayor parte de la evidencia experimental y de modelado que sustenta este mecanismo se concentra en campos débiles, del orden de magnitud del campo geomagnético (decenas de $\mu\mathrm{T}$) o comparables a los acoplamientos hiperfinos típicos (del orden de $\sim1\,\mathrm{mT}$), rango en el que el rendimiento singlete--triplete suele crecer con $B$. Los imanes utilizados en esta tesina generan campos de intensidad muy superior, de varias decenas de mT en la región cercana a su superficie. En ese rango, el sistema se aproxima a un régimen de campo alto, donde el efecto magnético sobre los rendimientos químicos tiende a saturarse o a variar de forma no lineal, en lugar de seguir creciendo proporcionalmente con la intensidad aplicada. Esto no invalida al RPM como mecanismo físico plausible para el presente trabajo, pero sí implica que no debe esperarse una relación simple de \textit{a mayor campo, mayor efecto} en el rango experimental utilizado.
